...
4. Create and push a matching version tag. For hotfixes on a milestone release, use letter suffixes such as `0.3.3a`, `0.3.3b`, and `0.3.3c`.
...
git tag -a v0.3.3 -m "0.3.3 Rewards and Run Modifiers cleanup"
